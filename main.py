...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, default='GridWorld-5D.POMDP', help='The name of environment\'s config file')
    ...
    parser.add_argument('--max_play', type=int, default=50, help='Maximum number of play steps')
